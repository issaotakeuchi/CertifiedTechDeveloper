...
function insert(num){
    var numero = document.getElementById('previous-operand').innerHTML;
    document.getElementById('previous-operand').innerHTML = numero + num;
}
...
function deleteNum(){
    ...
    document.getElementById('previous-operand').innerHTML = previousOperand.substring(0, previousOperand.length -1)
}
